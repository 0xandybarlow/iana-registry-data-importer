...
const applyPrimaryKeys = (
  ...
  const overrides: Record<string, string[]> = {
    ...
    oauth_token_endpoint_authentication_methods: ['token_endpoint_authentication_method_name'],
...
export const REGISTRIES_V2: { name: string; sources: V2DatasourceConfig[] }[] = [
  {
    name: 'OAuth Registry',
    sources: applyPrimaryKeys('oauth_registry', mapDatasets('oauth_registry', oauthRegistryDatasources)),
  },
  {
    name: 'JOSE Registry',
    sources: applyPrimaryKeys('jose_registry', mapDatasets('jose_registry', joseRegistryDatasources)),
  },
  {
    name: 'JWT Registry',
    sources: applyPrimaryKeys('jwt_registry', mapDatasets('jwt_registry', jwtRegistryDatasources)),
  },
];
